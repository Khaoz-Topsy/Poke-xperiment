import { Box, Button, Center, Flex, FormControl, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Switch, Text, VStack, createDisclosure } from '@hope-ui/solid';
...
export const LevelLayerControl: Component<ILevelLayerControlProps> = (props: ILevelLayerControlProps) => {
    ...
    const [selectedWalkableTileDisplay, setSelectedWalkableTileDisplay] = createSignal<Array<string>>(['none']);
                        ...
                        <Box>
                            ...
                            >
                                <Dropdown
                                    ...
                                    options={props.mapLookup.definitions.filter(def => def.tags.includes('background')).map(def => ({ title: def.type, value: def.type, backgroundImg: `var(--sprite-item-${def.type})` }))}
                                    onSelect={(value: any) => {
                                ...
                                <Dropdown
                                    ...
                                    onSelect={(value: any) => {
                                        ...
                                        const classesAfterRemoval = props.layerClasses.filter(c => allWalkableClasses.includes(c) === false);
