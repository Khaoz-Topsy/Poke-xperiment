...
export const Autocomplete: Component<IProps> = (props: IProps) => {
  ...
  const [optionsToDisplay, setOptionsToDisplay] = createSignal<Array<IAutocompleteOption>>(
    props.options,
  );
        ...
        <SelectTrigger onKeyDown={() => {}}>
          <Input
            ...
            onInput={(event) => {
              ...
              setOptionsToDisplay(props.options.filter((p) => p.value.includes(searchStr)));
            }}
          />
        </SelectTrigger>
