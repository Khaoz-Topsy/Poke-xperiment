...
export const getProgress = (stateService: StateService): [state: () => IProgressState, setState: (state: IProgressState) => void] => [
...
export const getProgressLevel = (stateService: StateService): [state: () => Level, setState: (state: Level) => void] => [
...
export const getProgressCoords = (stateService: StateService): [state: () => ILevelCoord, setState: (state: ILevelCoord) => void] => [
